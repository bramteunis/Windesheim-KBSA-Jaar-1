        ...
        <div id="titleCart">
            ...
            if(isset($_POST["afrekenensubmit"])){      
                 ...
                 foreach($cart as $artikelnummer => $aantalartikel){
                            ...
                            $nieuwevoorraad = intval($StockItem['QuantityOnHand']) - intval($aantalartikel);
                            //$Query2 = "
                            ...
                            debug_to_console("Nieuwevooraad van artikel: ". $artikelnummer." is: ".intval($StockItem['QuantityOnHand'])."-".intval($aantalartikel));
                            }
                 }
            ?>
        </div>
