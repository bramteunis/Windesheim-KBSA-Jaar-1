...
<!-- code voor US3: zoeken. -->
        <ul id="ul-class-navigation">
            <li>
                <a href="cart.php" class="HrefDecoration" aria-label="Winkelkar"><i class="fas fa-shopping-cart"></i> Winkelwagen</a>
                <!--
                <a href="cart.php" class="HrefDecoration" aria-label="Winkelkar">
            ...
            <li>
                <a href="browse.php" class="HrefDecoration" aria-label="Winkelkar"><i class="fas fa-search search" style="color: black"></i> </a>
            </li>
        </ul>
