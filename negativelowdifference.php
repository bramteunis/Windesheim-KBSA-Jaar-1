...
<br>
<a href='positivelowdifference.php' style='float:none;margin-top:10px;'>Positieve afwijking</a>
<a href='negativelowdifference.php' style='float:none;margin-top:10px;background:#03625a;'>Negatieve afwijking</a>
<?php
  
   
  
  $Query = "SELECT * FROM coldroomtemperatures WHERE Temperature > 33.4 ORDER BY (Temperature - 33.4) ASC";
